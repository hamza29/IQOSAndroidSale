...
public class LeadsAdapter extends RecyclerView.Adapter<LeadsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(LeadsAdapter.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mSharedPreferences.getString(Constants.ROLE, "").equalsIgnoreCase("sales")) {
                    ...
                    holder.llMainSaleshead.setVisibility(View.GONE);
                    ...
                    if (item.getType().equalsIgnoreCase("hc1") ||
                        ...
                        if (item.getIs_appointment().equalsIgnoreCase("0") || Objects.equals(item.getIs_multisale(), "1")) {
        ...
        if (mSharedPreferences.getString(Constants.ROLE, "").equalsIgnoreCase("sales")) {
            holder.tvAddMessage.setVisibility(View.GONE);
            holder.llMain.setVisibility(View.GONE);
            holder.llMainSaleshead.setVisibility(View.VISIBLE);
            holder.tvId.setText("" + item.getId() + " Date: " + item.getAssigned_at());
            holder.tvStatus.setText("" + item.getNumber().toString());
            holder.tvLastAction.setText(item.getEmail().toString());
            holder.tvNextAction.setText(item.getCreatedAt().toString());
            String saleNumber = (Objects.equals(item.getIs_multisale(), "1")) ? "Sale 2" : "Sale 1";
            holder.tvLastActionOutcome.setText(saleNumber);
            holder.tvNextActionOutcome.setText("" + item.getAgeGroup().toString());
        }
...
//                                getLeadsDetails(mSharedPreferences.getString(Constants.BAREAR_TOKEN,""),lead_id);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout llMain, llMainSaleshead;
        LinearLayout llSub;
        ...
        public ViewHolder(View itemView) {
            ...
            llMainSaleshead = itemView.findViewById(R.id.llMainSaleshead);
