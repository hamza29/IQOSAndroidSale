...
public class AppointmentBookingDetailHyperActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding.tvDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(AppointmentBookingDetailHyperActivity.this,
        ...
        mBinding.tvTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(AppointmentBookingDetailHyperActivity.this,
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (keyModel.getStatus().equals("1")) {
                                ...
                                Toast.makeText(AppointmentBookingDetailHyperActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                                mBinding.progress.setVisibility(View.GONE);
            ...
            public void onFailure(Call<Model.GenerealModel> call, Throwable t) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                        mBinding.progress.setVisibility(View.GONE);
                        Toast.makeText(AppointmentBookingDetailHyperActivity.this, "failure", Toast.LENGTH_SHORT).show();
                    }
                });
