...
public final class DaySevenDialogBinding implements ViewBinding {
  @NonNull
  ...
  private DaySevenDialogBinding(@NonNull RelativeLayout rootView, @NonNull Button btnCall,
      @NonNull Button btnMessage, @NonNull Button btnSubmit, @NonNull CheckBox cbCigrattes,
      @NonNull CheckBox cbIQOS, @NonNull CheckBox cbNicotine, @NonNull CheckBox cbOther,
      @NonNull CheckBox cbPouch, @NonNull CheckBox cbVpae, @NonNull EditText etQ1a,
      @NonNull EditText etQ2a, @NonNull EditText etQ3a, @NonNull ImageView ivBack,
      @NonNull ImageView ivLogo, @NonNull LinearLayout l1, @NonNull RadioButton rb0,
      @NonNull RadioButton rb1plus, @NonNull RadioButton rb95plus, @NonNull RadioGroup rbIsNotify,
  ...
  @NonNull
  public static DaySevenDialogBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DaySevenDialogBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.day_seven_dialog, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DaySevenDialogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DaySevenDialogBinding((RelativeLayout) rootView, btnCall, btnMessage, btnSubmit,
